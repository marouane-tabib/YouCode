			...
			<div class="modal-content">
				<form action="includes/scripts.php" method="POST" id="form-task">
					...
					<div class="modal-footer">
						...
						<button type="submit" name="delete" class="btn btn-danger task-action-btn" name="delete" id="task-delete-btn">Delete</a>
						<button type="submit" name="update" class="btn btn-warning task-action-btn" name="update" id="task-update-btn">Update</a>
						<button type="submit" name="save" class="btn btn-primary task-action-btn" name="save" id="task-save-btn">Save</button>
					</div>
				</form>
			</div>
		</div>
